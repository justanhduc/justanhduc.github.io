        ...
        p = function(a, b) {
            if ("undefined" == typeof b && (b = !0), !d(a.settings.height)) {
                var c = Math.round(a._attributes.container.offsetHeight),
                    e = c,
                    f = a._attributes.currentSlide.getAttribute("data-actual-width"),
                    g = a._attributes.currentSlide.getAttribute("data-actual-height");

                if (a._attributes.aspectWidth && a._attributes.aspectHeight) 
                    e = a._attributes.aspectHeight / a._attributes.aspectWidth * a._attributes.container.offsetWidth;
                else {
                ...
                var aspect = f > g ? f / g : g / f;
                if (a._attributes.container.offsetWidth < h * aspect) {
                    if (f > g)
                        h = a._attributes.container.offsetWidth * g / f;
                    else
                        h = a._attributes.container.offsetWidth * f / g;
                }
                
                a._attributes.container.style.height = h + "px";

                if (a._attributes.currentSlide.getAttribute("data-actual-width") < a._attributes.currentSlide.getAttribute("data-actual-height")) {
                    var w = h * a._attributes.currentSlide.getAttribute("data-actual-width") / a._attributes.currentSlide.getAttribute("data-actual-height");
                    a._attributes.currentSlide.style.width = w + "px";
                    a._attributes.currentSlide.style.margin = "0px " + (a._attributes.container.offsetWidth - w) / 2 + "px";
                }
